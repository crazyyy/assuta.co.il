...
function wpeHeaderScripts() {
  if (!is_admin()) {
    ...
    wp_register_script('vendor', get_template_directory_uri() . '/js/vendor.js', array(), '1.0.0', true); // Custom scripts
...
function register_html5_menu() {
  register_nav_menus(array(
    ...
    'header-menu-bottom' => __('Меню в шапке ниже', 'wpeasy'),
